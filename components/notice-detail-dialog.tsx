...
export function NoticeDetailDialog({ notice, open, onOpenChange, onEdit, onDelete }: NoticeDetailDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>공지사항의 상세 내용을 확인합니다.</DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
          ...
          <div className="grid grid-cols-4 items-start gap-4">
            ...
            <div className="col-span-3 whitespace-pre-wrap">{notice.content}</div>
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
            <div className="font-semibold">작성자</div>
            <div className="col-span-3">{notice.author}</div>
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
