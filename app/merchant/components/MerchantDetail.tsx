...
export default function MerchantDetailDialog({ merchant, onClose, onSave }: Props) {
  ...
  const handleSave = () => {
    ...
    const updatedMerchant = {
      ...merchant,
      name: formData.name,
      phoneNumber: formData.phoneNumber || merchant.phoneNumber,
      pin: formData.pin,
    };
      ...
      <Dialog open={true} onOpenChange={onClose}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>가맹점 상세 정보를 수정합니다.</DialogDescription>
          </DialogHeader>
